...
public class ViewInjectTest {
    public static void inject(final Activity activity)
    {
        ...
        for (int i = 0; i < declaredFields.length; i++) {
            ...
            //获取到字段上面的注解对象
            MyViewInject annotation = (MyViewInject)field.getAnnotation(MyViewInject.class);
        ...
        for (int i = 0; i < declaredMethods.length; i++) {
            ...
            //获取方法上面的注解
            MyOnClick annotation = (MyOnClick)method.getAnnotation(MyOnClick.class);
            if (annotation == null) {
                //如果该方法上没有注解，循环下一个
                continue;
            }
