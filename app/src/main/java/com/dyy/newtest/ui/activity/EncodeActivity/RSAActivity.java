...
//        LogUtils.e(Base64.encodeToString(aPublic.getEncoded(),Base64.DEFAULT));
        ...
        SecretKeySpec secretKeySpec = AES.generateKey(seed);
        LogUtils.e(AES.byte2hex(secretKeySpec.getEncoded()));
        ...
        String encryptKEY1 = AES.encrypt(str, KEY1);
        LogUtils.e(encryptKEY1);
        String decryptKEY1 = AES.decrypt6(AES.hex2byte(encryptKEY1), KEY1);
        LogUtils.e(decryptKEY1);
        String encryptKEY2 = AES.encrypt(str, KEY2);
        LogUtils.e(encryptKEY2);
        String decryptKEY2 = AES.decrypt6(AES.hex2byte(encryptKEY2), KEY2);
        LogUtils.e(decryptKEY2);
        String encryptKEY3 = AES.encrypt(str, KEY3);
        LogUtils.e(encryptKEY3);
        String decryptKEY3 = AES.decrypt6(AES.hex2byte(encryptKEY3), KEY3);
        LogUtils.e(decryptKEY3);
    }
